...
Figures \@ref(fig:appendixfig1) and \@ref(fig:appendixfig2)

```{r appendixfig1, fig.cap="S.", fig.align="center", echo=FALSE}

knitr::include_graphics(paste0(figdir,'pupildataRep.pdf'))

```

```{r appendixfig2, fig.cap="S.", fig.align="center", echo=FALSE}
