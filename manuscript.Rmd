...
domodelling <- 1    # if set to 1, run the Stan models (takes ~24 hours)
...
numSavedSteps <- 1000    # total number of MCMC steps
...
legend(21,0.03,c('Monocular','Binocular','Dichoptic','Dichoptic cross'),lwd=3,col=colpal[condlist],box.lwd=2)
...
plotlims <- c(15,40,0,0.6)  
ticklocsy <- seq(0,0.6,0.2)    # locations of tick marks on y axis
ticklabelsy <- ticklocsy    # set labels for y ticks
...
text(17,0.55,'(f)',adj=0.5,cex=2.5)
...
text(17,0.55,'(b)',adj=0.5,cex=2.5)
