...
cond <- 6
  points(contrastsdB,abs(cleanmeansP[cond,]), pch = 25, col='black', bg=colpal[cond], cex=1.6, lwd=3) 
...
cond <- 6
  points(contrastsdB,abs(cleanmeansEav[cond,]), pch = 25, col='black', bg=colpal[cond], cex=1.6, lwd=3)   # draw the data points 
...
cond <- 6
  points(contrastsdB,abs(cleanmeansE2av[cond,]), pch = 25, col='black', bg=colpal[cond], cex=1.6, lwd=3)  
