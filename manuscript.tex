...
The results from the second experiment are shown in figure \ref{fig:TFdata}. In figures 5A to 5C, the curves are showing the results for the monocular and the binocular configurations. In figure 5D, the curves are showing the results for the two harmonics.
